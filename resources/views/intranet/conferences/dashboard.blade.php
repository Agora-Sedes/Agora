...
@section('header_action')
    <form action="{{ route('intranet.logout') }}" method="post">
        @csrf
        <button type="submit" class="header-action">Cerrar sesiÃ³n</button>
    </form>
@endsection
...
<div class="container section">
    ...
    <h2 class="page-title" style="margin-top: 12px;">Panel de administracion</h2>
    ...
    <div class="link-stack" style="max-width: 560px;">
        ...
        <a href="{{ route('intranet.conferences.attendants.new', [ 'id' => $conference->id ]) }}">Agregar inscripto de ultimo momento</a>
